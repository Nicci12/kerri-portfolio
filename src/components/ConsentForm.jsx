    ...
    <ul>
      <li data-aos="fade-right" data-aos-duration="1200">
        <div className="list_inner">
          ...
          {/* Start Modal */}
          <Modal isOpen={isOpen} onRequestClose={toggleModalOne} contentLabel="My dialog" className="custom-modal"
            overlayClassName="custom-overlay" closeTimeoutMS={500}>
                  ...
                  <div className="main_content">
                    <div className="descriptions">
                      <div style={{
                        ...
                        <button className="modal_button" onClick={openModalOne}>
                          Face To Face Therapy
                        </button>
                        <button className="modal_button" onClick={openModalTwo}>
                          Online Therapy-Teletherapy
                        </button>
                      </div>
                      <Modal className="custom-modal" overlayClassName="custom-overlay" closeTimeoutMS={500}
                        isOpen={isModalOneOpen} onRequestClose={closeModalOne}>
                        <div className="box_inner">
                          <div className="description_wrap scrollable">
                            <div className="details">
                              <h6 className="title">
                      ...
                      <Modal className="custom-modal" overlayClassName="custom-overlay" closeTimeoutMS={500}
                        isOpen={isModalTwoOpen} onRequestClose={closeModalTwo}>
                        <div className="box_inner">
                          <div className="description_wrap scrollable">
                            <div className="details">
                              <h6 className="title">
      ...
      <li data-aos="fade-right" data-aos-duration="1200" data-aos-delay="300">
        <div className="list_inner">
          ...
          {/* Start Modal */}
          <Modal isOpen={isOpen3} onRequestClose={toggleModalThree} contentLabel="My dialog" className="custom-modal"
            overlayClassName="custom-overlay" closeTimeoutMS={500}>
            <div className="beny_tm_modalbox_news">
      ...
      <li data-aos="fade-right" data-aos-duration="1200" data-aos-delay="150">
        <div className="list_inner">
          ...
          <Modal isOpen={isOpen2} onRequestClose={toggleModalTwo} contentLabel="My dialog" className="custom-modal"
            overlayClassName="custom-overlay" closeTimeoutMS={500}>
            <div className="beny_tm_modalbox_news">
